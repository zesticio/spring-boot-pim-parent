...
public enum VariantHttpStatus {
  ...
  private static final Map<Integer, VariantHttpStatus> LOOKUP = new HashMap<Integer, VariantHttpStatus>();

  static {
    for (final VariantHttpStatus enumeration : VariantHttpStatus.values()) {
  ...
  private VariantHttpStatus(final Integer code, final String message) {
    this.code = code;
