...
public enum CollectHttpStatus {
  ...
  private static final Map<Integer, CollectHttpStatus> LOOKUP = new HashMap<Integer, CollectHttpStatus>();

  static {
    for (final CollectHttpStatus enumeration : CollectHttpStatus.values()) {
  ...
  private CollectHttpStatus(final Integer code, final String message) {
    this.code = code;
