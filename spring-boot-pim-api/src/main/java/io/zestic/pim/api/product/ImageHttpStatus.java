...
public enum ImageHttpStatus {
  ...
  private static final Map<Integer, ImageHttpStatus> LOOKUP = new HashMap<Integer, ImageHttpStatus>();

  static {
    for (final ImageHttpStatus enumeration : ImageHttpStatus.values()) {
  ...
  private ImageHttpStatus(final Integer code, final String message) {
    this.code = code;
