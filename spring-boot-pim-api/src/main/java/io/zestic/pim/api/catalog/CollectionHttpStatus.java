...
public enum CollectionHttpStatus {
  ...
  private static final Map<Integer, CollectionHttpStatus> LOOKUP = new HashMap<Integer, CollectionHttpStatus>();

  static {
    for (final CollectionHttpStatus enumeration : CollectionHttpStatus.values()) {
  ...
  private CollectionHttpStatus(final Integer code, final String message) {
    this.code = code;
