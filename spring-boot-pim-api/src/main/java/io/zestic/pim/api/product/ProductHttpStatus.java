...
public enum ProductHttpStatus {
  ...
  private static final Map<Integer, ProductHttpStatus> LOOKUP = new HashMap<Integer, ProductHttpStatus>();

  static {
    for (final ProductHttpStatus enumeration : ProductHttpStatus.values()) {
  ...
  private ProductHttpStatus(final Integer code, final String message) {
    this.code = code;
