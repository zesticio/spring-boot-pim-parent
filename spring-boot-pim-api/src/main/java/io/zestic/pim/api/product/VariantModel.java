...
public class VariantModel extends Model<Integer, VariantModel> implements Auditable {
    ...
    @Builder
  public VariantModel(Integer id, String barcode, Double compareAtPrice, String fulfillmentService, String grams, Integer imageId, Integer inventoryItemId, String inventoryManagement, String inventoryPolicy, Integer inventoryQuantity, Integer oldInventoryQuantity, Integer inventoryQuantityAdjustment, Double price, Integer productId, String sku, Boolean taxable, String taxCode, String title, String weight, String weightUnit) {
    this.id = id;
